#ifndef HADRYAN_INPUT_PATH_NOT_INTERGER_H
#define HADRYAN_INPUT_PATH_NOT_INTERGER_H
...
friend i_sink<input_path_not_interger<SINK>>;
    ...
    inline bool is_int(rvgf a) const {
        return (a - std::floor(a)) == 0.000f;
    }

    inline rvgf f(rvgf a) const {
        return is_int(a) ? a+0.001f : a;
    }
...
#endif // HADRYAN_INPUT_PATH_NOT_INTERGER_H