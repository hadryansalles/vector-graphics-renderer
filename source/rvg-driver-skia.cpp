...
static SkShader::TileMode spread_to_skia(e_spread s) {
    switch (s) {
        case e_spread::clamp: return SkShader::TileMode::kClamp_TileMode; break;
        case e_spread::wrap: return SkShader::TileMode::kRepeat_TileMode; break;
        case e_spread::mirror: return SkShader::TileMode::kMirror_TileMode; break;
        case e_spread::transparent:
        default: return SkShader::TileMode::kDecal_TileMode;break;
    }
}
